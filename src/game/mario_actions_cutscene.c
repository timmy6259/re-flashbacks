    ...
    switch (m->actionState) {
        ...
        case 0:
            ...
            if (is_anim_past_end(m)) {
                ...
                if (gLastCompletedCourseNum == COURSE_BITDW || gLastCompletedCourseNum == COURSE_BITFS || gLastCompletedCourseNum == COURSE_BITS) {
        ...
        case 4:
            animFrame = set_mario_animation(m, MARIO_ANIM_QUICKLY_PUT_CAP_ON);
            switch (animFrame) {
                case 6:
